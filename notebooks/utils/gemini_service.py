...
class GeminiModel:
    def __init__(self, model_name, temperature=0.7, max_output_tokens=1024, max_retries=5, wait_time=30):
        """
...
class GeminiJsonEngine():
    def __init__(self, model_name, basemodel, temperature, max_output_tokens, systemInstructions, max_retries=5, wait_time=30):
        self.model = GeminiModel(model_name=model_name, temperature=temperature, max_output_tokens=max_output_tokens, max_retries=max_retries, wait_time=wait_time)
        self.content_roles = []
...
class GeminiSimpleChatEngine:
    def __init__(self, model_name, temperature, max_output_tokens, systemInstructions, max_retries=5, wait_time=30):
        self.model = GeminiModel(model_name=model_name, temperature=temperature, max_output_tokens=max_output_tokens, max_retries=max_retries, wait_time=wait_time)
        self.content_roles = []
        if systemInstructions:
            self.content_roles.append({"role": "user", "content": systemInstructions})
